...
Welcome to the documentation of IMPERIAL-FEAST (Static Restaurant App)! This simple web application is built using **HTML, CSS, and JavaScript** to showcase a static representation of a restaurant's website.
...
git clone https://github.com/your-username/IMPERIAL-FEAST.git
```
